...
public class AttrController {
    ...
    public Result index(@ApiParam(name = "attrGroupId", value = "分组id", required = true) @PathVariable Long attrGroupId) {
        return Result.ok(attrService.getAttrListByGroupId(attrGroupId));
    }
