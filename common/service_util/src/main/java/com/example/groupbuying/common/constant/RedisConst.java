package com.example.groupbuying.common.constant;
...
public class RedisConst {
    ...
    //单位：秒
    public static final long SKU_KEY_TIMEOUT = 24 * 60 * 60;
    // 定义变量，记录空对象的缓存过期时间 缓存穿透key的过期时间
    public static final long SKU_KEY_TEMPORARY_TIMEOUT = 10 * 60;

    //单位：秒 尝试获取锁的最大等待时间
    public static final long SKU_LOCK_EXPIRE_PX1 = 1;
    //单位：秒 锁的持有时间
    public static final long SKU_LOCK_EXPIRE_PX2 = 1;
